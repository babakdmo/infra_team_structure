...
| **Amazon (AWS)** | EMR/YARN fleets, Redshift clusters, S3 Lake, Glue Catalog             | Glue ETL, Kinesis / MSK + Flink streaming                           | SageMaker + Feature Store + Clarify  | Redshift-Serverless, Athena, QuickSight |
